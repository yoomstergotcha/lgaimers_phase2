# -*- coding: utf-8 -*-
"""
추론 실행 코드 (Inference Script) - PyTorch Tabular ResNet v3 (12-Epochs 심층 집중 학습 5-Fold)
...
def main():
    ...
    print("=" * 60)
    print("[INFO] PyTorch Tabular ResNet v3 (12-Epochs 심층) 5-Fold 추론 시작")
    print("=" * 60)
    ...
    meta_path = os.path.join(model_dir, "metadata_nn_v3.pkl")
    ...
    for fold in range(5):
        ...
        model = TabularResNetV3(emb_dims, len(num_cols), hidden_dim=256, dropout=0.0).to(device)
